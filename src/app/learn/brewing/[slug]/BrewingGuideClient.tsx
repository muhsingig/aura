...
import { BrewingMethod } from "@/lib/brewing-data";
...
interface BrewingGuideClientProps {
    method: Omit<BrewingMethod, "icon">;
}

export default function BrewingGuideClient({ method }: BrewingGuideClientProps) {
    if (!method) {
        ...
        <div className="min-h-screen bg-brand-dark text-brand-cream font-sans">
            ...
            <div className="relative h-[50vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-20 text-center max-w-4xl px-6">
                    ...
                    <p className="text-xl opacity-80 max-w-2xl mx-auto mb-12">{method.description}</p>
