...
export default function PixelCard({ variant = 'default', gap, speed, colors, noFocus, className = '', children }: PixelCardProps) {
    ...
    const timePreviousRef = useRef(0); // Initialize with 0 or a dummy value, updated in effect
    ...
    const initPixels = () => {
        ...
        const pxs = [];
        for (let x = 0; x < width; x += parseInt(finalGap as string, 10)) {
            for (let y = 0; y < height; y += parseInt(finalGap as string, 10)) {
